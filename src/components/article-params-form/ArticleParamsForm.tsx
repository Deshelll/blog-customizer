...
import { defaultArticleState, fontFamilyOptions, backgroundColors, contentWidthArr, fontColors, fontSizeOptions, ArticleStateType } from 'src/constants/articleProps';
...
export const ArticleParamsForm = ({ optionState, onSetOptions}: ArticleProp) => {
	...
	const openContainer = clsx(
		styles.container,
		isOpen && styles.container_open
	);

	const handleChangeOption = (key: keyof typeof formOptions, value: any) => {
				...
				<aside className={openContainer}>
					<form className={styles.form} onSubmit={handleSubmit}>
						...
						<RadioGroup 
							...
							name='fontSize' onChange={(value) => handleChangeOption('fontSizeOption', value)}/>
						<Select 
							title='Цвет шрифта' 
							options={fontColors} 
